...
class STInterpreter(sessionType: SessionType, path: String, preamble: String, partialIdentityMon: Boolean) {
  ...
  var synthMon = new SynthMon(this, path, partialIdentityMon)
